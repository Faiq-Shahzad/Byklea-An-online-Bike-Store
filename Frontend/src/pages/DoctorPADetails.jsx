...
const DoctorPADetails = () => {
  const { data, assistant, setDoctor } = useContext(UserContext);
  const [disable, setDisable] = useState(true);
  const [editData, seteditData] = useState({
    name: assistant.docName,
    email: assistant.docEmail,
    cnic: assistant.docCnic,
    contact: assistant.docContact,
  });
  // const [editData, seteditData] = useState({
  //   name: data.adminName,
  ...
  const updateData = async (e) =>{
    ...
    try{
      const response = await axios.put(`${backendUrl}doctors/updatebyAdminPA/${assistant.docCnic}`, editData, {
        headers: {
...
export default DoctorPADetails;
