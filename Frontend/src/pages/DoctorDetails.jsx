  ...
  return (
    <div className="flex items-center h-full">
      <div className="w-1/2 bg-white rounded-lg shadow-2xl p-8 m-4 mx-auto my-auto">
        ...
        <div className="flex image gap-4 place-content-center">
          <img
            className="rounded-full w-20 h-20 place-content-center"
            src={`data:image/jpeg;base64,${doctor.docPic}`}
            alt="doctor"
          />
        ...
        <form action="/">
          ...
          {/* <div className="flex flex-col mb-4">
            ...
            <select className="border py-2 px-3 text-grey-800" disabled={disable}>
              <option>Male</option>
